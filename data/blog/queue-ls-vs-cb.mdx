---
title: 'Queue Implementation: Linked List vs Circular Buffer'
date: '2023-08-27'
tags: ['CPP', 'Data Structures', 'Queue']
draft: false
summary: A brief explanation of the queue data structure and a benchmark of its implementations with Linked List and Circular Buffer.
---
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    ![Array Implementation of Queue](/static/images/queue-ls-vs-cb/linked_list.jpg)
</div>
...
<div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    ![Array Implementation of Queue](/static/images/queue-ls-vs-cb/circular_buffer.jpg)
</div>
